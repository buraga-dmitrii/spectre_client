...
class LoginsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create login" do
    assert_difference('Login.count') do
      post logins_url, params: { login: { customer_id: @login.customer_id, hashid: @login.hashid, login_id: @login.login_id, provider: @login.provider, status: @login.status } }
    end
  ...
  test "should update login" do
    patch login_url(@login), params: { login: { customer_id: @login.customer_id, hashid: @login.hashid, login_id: @login.login_id, provider: @login.provider, status: @login.status } }
